...
- ❌ MUST exclude: Test files (**tests**/, \*.test.ts, ios/Tests/, android/src/test/)
...
- ✅ AND script FAILS if _.test.ts, _.spec.ts, or \*Tests.swift files found
- ✅ AND script FAILS if **tests**/, ios/Tests/, or example/ directories found
...
- [ ] Verify no **tests**/ or ios/Tests/ directories

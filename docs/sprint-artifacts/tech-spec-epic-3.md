...
function addAudioSamplesListener(
  callback: (event: AudioSample) => void
): Subscription
// Frequency: ~8 Hz at 16kHz/2048 config
// Platform: Works on iOS and Android

// Listen for status changes
function addStreamStatusListener(
  callback: (event: StreamStatus) => void
): Subscription

// Listen for errors
function addStreamErrorListener(
  callback: (event: StreamError) => void
): Subscription

...
// Event Listeners
export function addAudioSamplesListener(callback: (event: AudioSampleEvent) => void): Subscription;

export function addStreamStatusListener(callback: (event: StreamStatusEvent) => void): Subscription;

export function addStreamErrorListener(callback: (event: StreamErrorEvent) => void): Subscription;
...
- All TypeScript files copied from v0.2.0: index.ts, src/_.ts, hooks/_.tsx
...
- All test files copied from v0.2.0: **tests**/_.test.ts, **tests**/_.test.tsx
...
- Layer 3 (npm): .npmignore excludes **tests**/, \*.test.ts, ios/Tests/, android/src/test/
...
| **AC2**  | APIs and Interfaces → Public JavaScript API           | index.ts, src/_.ts, hooks/_.tsx                | TypeScript compilation, API export verification      | FR14, FR17, FR18, FR19   | 2.1     |
...
| **AC6**  | Services and Modules → TypeScript                     | **tests**/\*.test.ts                           | npm test (zero failures)                             | FR20                     | 2.5     |
...
- **Execution:** `npm test` runs all **tests**/\*.test.ts files
